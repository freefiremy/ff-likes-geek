...
const p1 = { a: ['aHR0cHM6Ly9saWtlcy4=', 'YXBpLmZyZWVmaXJl', 'b2ZmaWNpYWwuY29tL2FwaS9zZy8='], b: ['aHR0cHM6Ly9hcGku', 'YWxsb3JpZ2lucy53aW4=', 'L3Jhdz91cmw9'], c: ['aHR0cHM6Ly9ub2RlanMt', 'aW5mby52ZXJjZWVsLmFwcC8=', 'L2luZm8='] };
const d1 = {
...
function g3(id) { return p1.a.map(atob).join('') + id + '?key=' + encodeURIComponent(g1()); }
function g4(id) {
...
function g5(e) { const n = new Date(); return Math.max(0, Math.ceil((e - n) / (1000 * 60 * 60 * 24))); }
      ...
      respDiv.innerHTML = `
        <div class="response-success animate-success">
          ...
          <div class="response-text space-y-2">
            ...
            ❤️ <strong>Given:</strong> ${dt.response.LikesGivenByAPI}<br>
